...
BEGIN
	...
	SELECT @RoomStatus = rm.Status FROM Room rm WHERE rm.RoomID=@RoomNumber
	...
	ELSE
		BEGIN
			...
			END
			ELSE
				PRINT(CONCAT('Sorry. Room Number ', @RoomNumber, ' Is Currently ', @RoomStatus, ', Please Choose A Different Room.'))
		END
END
GO
BookingInsertSP 26,20,5,'2024-07-01','2024-07-10','cash'
GO
--SELECT * FROM Booking
--GO
--SELECT * FROM Payment
